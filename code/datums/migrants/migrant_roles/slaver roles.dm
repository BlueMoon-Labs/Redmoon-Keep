/datum/migrant_role/slaver/master
	...
	allowed_races = RACES_SHUNNED_UP // REDMOON CHANGE RACES_TOLERATED_UP ---> RACES_SHUNNED_UP
...
/datum/outfit/job/roguetown/slaver/master/pre_equip(mob/living/carbon/human/H)
	...
	backpack_contents = list(/obj/item/reagent_containers/glass/bottle/rogue/healthpot = 2, /obj/item/rope/chain = 1, /obj/item/flint = 1, /obj/item/clothing/neck/roguetown/collar/leather/cursed = 2, /obj/item/leash/chain = 3, /obj/item/license/rogue/slaverlicense)
	if(H.mind)
