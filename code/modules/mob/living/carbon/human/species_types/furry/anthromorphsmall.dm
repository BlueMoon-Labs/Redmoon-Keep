...
/datum/species/anthromorphsmall
	...
	offset_features = list(
		OFFSET_ID = list(0,0), OFFSET_GLOVES = list(0,1), OFFSET_WRISTS = list(0, -3),\
		...
		OFFSET_ID_F = list(0,-4), OFFSET_GLOVES_F = list(0,0), OFFSET_WRISTS_F = list(0,-4), OFFSET_HANDS_F = list(0,-4), \
