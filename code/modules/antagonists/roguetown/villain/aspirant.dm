...
/datum/antagonist/aspirant/loyalist/greet()
	to_chat(owner, span_danger("Long live the Baron! I love my ruler. But I have heard that some seek to overthrow them. I cannot let that happen."))

/datum/antagonist/aspirant/supporter/greet()
	to_chat(owner, span_danger("Long live the Baron! But not this one. I have been approached by an Aspirant and swayed to their cause. I must ensure they take the throne."))
...
/datum/objective/aspirant/coup/two
	name = "Moral"
	explanation_text = "I am no kinslayer, I must make sure that the baron doesn't die."
	triumph_count = 10
	var/initialruler
...
/datum/objective/aspirant/loyal/two
	name = "Loyalist"
	explanation_text = "I must ensure that the Baron continues to reign."
	triumph_count = 3
	var/initialruler
